...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) //jpa기능까지 한번에 테스트할때 사용.. = @TestRestTemplate
public class PostsApiControllerTest {
    ...
    //Gradle-Tasks-verification-test 추가코드 (setup()까지)
    @Autowired
    ...
    @Test
    @WithMockUser(roles="USER") //인증된 모의사용자를 만들어서 사용, roles에 권한추가가능, 권한을 가진 사용자가 api를 요청하는 효과
 ...
 //       ResponseEntity<Long> responseEntity = restTemplate.postForEntity(url, requestDto, long.class);
        ...
        //Gradle-Tasks-verification-test 추가코드
